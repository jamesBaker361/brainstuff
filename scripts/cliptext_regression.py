...
train_clip = np.load(os.environ["BRAIN_DATA_DIR"]+'/extracted_features/subj{:02d}/nsd_cliptext_train.npy'.format(sub))
test_clip = np.load(os.environ["BRAIN_DATA_DIR"]+'/extracted_features/subj{:02d}/nsd_cliptext_test.npy'.format(sub))
...
np.save(os.environ["BRAIN_DATA_DIR"]+'/predicted_features/subj{:02d}/nsd_cliptext_predtest_nsdgeneral.npy'.format(sub),pred_clip)
...
with open(os.environ["BRAIN_DATA_DIR"]+'/regression_weights/subj{:02d}/cliptext_regression_weights.pkl'.format(sub),"wb") as f:
