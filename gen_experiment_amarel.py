    ...
    for translate in ["trans","untrans"]:
        for recons in ["recons","unrecons"]:
            for disc in ["disc","no_disc"]:
                ...
                command=f" sbatch -J cycle --err=slurm/cycle/{name}.err --out=slurm/cycle/{name}.out --exclude=gpu[005,006,010-014,017,018],cuda[001-008],pascal[001-010] runpygpu.sh "
